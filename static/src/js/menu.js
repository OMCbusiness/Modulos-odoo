...
patch(NavBar.prototype, {
    async setup(parent, menuData) {
        ...
        $(document).on('click', 'body.top_menu_vertical_mini_2 .o_navbar_apps_menu a', function (ev) { self._ShowCurrentMenus(ev) });
        $(document).on('click', 'body.top_menu_vertical_mini .o_navbar_apps_menu .main_link', function (ev) { self._ShowCurrentMenusNew(ev) });
        $(document).on('click', 'body.top_menu_vertical_mini .o_navbar_apps_menu .spiffy_main_app', function (ev) { self._ShowCurrent(ev) });
        ...
        $(document).on('click', '.o_navbar_apps_menu .spiffy_main_group', function (ev) { self._AppsMainMenuClick(ev) });        
    ...
    _ShowCurrentMenusNew: function (ev) {
        ...
        if ($('body').hasClass('top_menu_vertical_mini')) {
            if ($(ev.currentTarget).hasClass('spiffy_main_app')) {
                if ($(ev.currentTarget).hasClass('active')) {
                    $('.header-sub-menus').removeClass('show').hide();
                    $blurOverlay.removeClass('background-blur').show();  
                    $backgroundOverlay.addClass('header-background').hide();   
                } else {
                    const $currentMenu = $(ev.currentTarget).next('.header-sub-menus')
                    $('.header-sub-menus.show').removeClass('show').hide();

                    // Then show only the current submenu
                    $blurOverlay.addClass('background-blur').show();  
                    $currentMenu.addClass('show').show();
        ...
        if ($(ev.target).hasClass('active')) {
            ...
            $(ev.target).parent().parent().find('div').removeClass('show')
            $(ev.target).parent().parent().find('a.main_link').removeClass('active')
            $(ev.target).parent().find('div').addClass('show')
    ...
    _SpiffyMenuGroupList: function (ev) {
        ...
        if ($('body').hasClass('top_menu_vertical_mini')) {
            ...
            $('.header-sub-menus').removeClass('show').hide();
            $('.spiffy_main_app').removeClass('active').hide();
            $('.app_menu_group').removeClass('active').hide();
            $('.submenu-link').removeClass('active').hide();
            $blurOverlay.removeClass('background-blur').hide(); 
            ($backgroundOverlay).removeClass('header-background').hide();   
        }
    },
    ...
    _AppsMainMenuClick: function (ev) {
        ...
        if ($('body').hasClass('top_menu_vertical_mini')) {
            if ($('spiffy_main_group').hasClass('active')) {
                $('spiffy_main_group').removeClass('active');
            }else{
                $('spiffy_main_group').addClass('active');
            }
            ...
            if ($target.hasClass('active')) {
                ...
                $target.closest(".header-sub-menus").closest("div").find($backgroundOverlay).addClass('header-background').show(); 
            }else{
    ...
    _onMenuGroupClick: function (ev) {
        ...
        if ($('body').hasClass('top_menu_vertical_mini')) {
            ...
            if ($(ev.currentTarget).hasClass('app_menu_group')) {
                if ($target.hasClass('active')) {
                    $('.header-sub-menus').removeClass('show').hide();
                } else {
                    $('.header-sub-menus').removeClass('show').hide();
            ...
            if ($(ev.currentTarget).hasClass('active')) {
                ...
                $blurOverlay.removeClass('background-blur').show();
                $backgroundOverlay.removeClass('header-background').show();
            }
        }

        if ($('body').hasClass('top_menu_vertical')|| $('body').hasClass('top_menu_vertical_mini_2')) {
            var $clicked = $(ev.currentTarget);
